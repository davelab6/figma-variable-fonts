...
const interFont = 'https://cdn.jsdelivr.net/gh/google/fonts@master/ofl/inter/Inter[slnt,wght].ttf';
const recursiveFont = 'https://variable-font.s3.amazonaws.com/Recursive_VF_1.063.ttf';

function FontSetupModule() {
  const dispatch = useDispatch();
  useEffect(() => {
    const fontUrl = recursiveFont;
    const samsaOptions = {
      url: fontUrl,
