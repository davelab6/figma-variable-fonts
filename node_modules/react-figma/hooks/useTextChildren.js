...
exports.useTextChildren = function (nodeRef) {
    ...
    React.useEffect(function () {
        ...
        var subject = $setTextChildren.pipe(operators_1.filter(function (message) { return message.node === instance; }), operators_1.map(function (message) { return message.characters; }));
