...
import { AutoLayoutProps, BorderProps, CornerProps, DefaultContainerProps, DefaultShapeProps, InstanceItemProps, SelectionEventProps, StyleOf } from '../../types';
...
export declare const FRAME_PRESETS: {
    iPhoneX: {
        name: string;
        width: number;
        height: number;
...
export interface FrameNodeProps extends DefaultShapeProps, DefaultContainerProps, InstanceItemProps, SelectionEventProps, AutoLayoutProps, BorderProps, CornerProps {
