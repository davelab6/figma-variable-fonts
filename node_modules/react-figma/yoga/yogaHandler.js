...
var messagePromise_1 = require("../helpers/messagePromise");
...
var transformNodesToTree = function (node) {
    ...
    return {
        width: node.width,
        height: node.height,
        style: (node.getPluginData && node.getPluginData('reactStyle') && JSON.parse(node.getPluginData('reactStyle'))) ||
            undefined,
        children: children && children.length > 0 ? children : undefined,
        nodeBatchId: nodeBatchId
    };
};
var transformYogaToCoords = function (result) {
    return {
        x: result.left,
        y: result.top,
        width: result.width,
...
exports.yogaHandler = function (node) { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, messagePromise_1.messagePromise({
                    type: 'calculateLayout',
                    value: transformNodesToTree(node)
                })];
            case 1:
                result = _a.sent();
                return [2 /*return*/, transformYogaToCoords(result)];
        }
    });
}); };
//# sourceMappingURL=yogaHandler.js.map